...
-- ============================================================================
-- T085 — list_exam_submissions(exam_id uuid)
-- Returns submissions with evidence summary for an exam.
-- Gated by exam.instructor_id = auth.uid().
-- ============================================================================
...
BEGIN
  ...
  RETURN (
    ...
    LEFT JOIN public.evidence_packages ep ON ep.session_id = s.session_id
